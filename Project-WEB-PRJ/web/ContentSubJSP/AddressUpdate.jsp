<%-- 
    Document   : AddressUpdate
    Created on : 6 thg 3, 2023, 10:45:28
    Author     : 84384
--%>
    ...
    <head>
        ...
        <script>
            ...
            function load_servlet(MethodType) {
                document.getElementById('cal').action= "../UpdateAddress";
    ...
    <body>
        ...
        <form id="cal">
            ...
            <div class="main-container align-bottom" style="display: flex; text-align: end;">
                <div>
                    <button style="width: 80px; height: 30px;"  class="align-bottom" onclick="closeWindow()">Go back</button>
                </div>
                <div>

                    <button style="width: 80px; height: 30px;" class="align-bottom"onclick="load_servlet('GET')">
                        Commit</button>
                </div>
