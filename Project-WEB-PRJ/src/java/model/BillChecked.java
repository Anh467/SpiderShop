...
public class BillChecked {
    ...
    public BillChecked(String userId, String aniId, String imgUrl, String titleAni, double rootMoney,double rootMoney2,double rootMoney3,double rootMoney4, int aniNumber, int aniNumber2, int aniNumber3, int aniNumber4, int stt) {
        this.userId = userId;
